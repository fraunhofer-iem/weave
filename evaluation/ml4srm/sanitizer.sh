...
python -m venv weave_env_san
source weave_env_san/bin/activate
...
java -Xms20g -Xmx200g -jar ${WEAVE_HOME}/target/cli-1.0-jar-with-dependencies.jar -t weka -c ${WEAVE_HOME}/evaluation/ml4srm/swan/sanitizer.properties -X -e "$MODEL"
