...
case "$MODEL_TAG" in
  weave) MODEL="weka.classifiers.meta.Bagging -P 179 -S 1 -num-slots 1 -I 28 -W weka.classifiers.trees.RandomForest -do-not-check-capabilities -- -P 100 -I 122 -num-slots 1 -do-not-check-capabilities -K 0 -M 1.0 -V 0.001 -S 1" ;;
...
java -XX:MaxRAMPercentage=75 -Dweave.predict.threads=32 -jar ${WEAVE_HOME}/target/cli-1.0-jar-with-dependencies.jar -t weka -c ${WEAVE_HOME}/evaluation/ml4srm/sscm/sscm.properties -X -e "$MODEL"
