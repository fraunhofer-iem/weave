...
case "$MODEL_TAG" in
  weave) MODEL="weka.classifiers.meta.RandomSubSpace -P 0.83125 -S 1 -num-slots 1 -I 61 -W weka.classifiers.functions.Logistic -do-not-check-capabilities -- -R 1.9285573065288986 -M 10 -do-not-check-capabilities -num-decimal-places 4" ;;
...
VENV="${WEAVE_HOME}/weave_env_cwe79"
...
java -XX:MaxRAMPercentage=75 -jar ${WEAVE_HOME}/target/cli-1.0-jar-with-dependencies.jar -t weka -c ${WEAVE_HOME}/evaluation/ml4srm/swan/cwe79.properties -X -e "$MODEL"
