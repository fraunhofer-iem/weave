...
public class SciKit {
    ...
    private final Logger LOGGER = LoggerFactory.getLogger(SciKit.class.getName());
     ...
     * @throws Exception
     */
    public  void selectScikitLearnModel(int cpu, String arffFile, long duration, long seed) throws Exception {
